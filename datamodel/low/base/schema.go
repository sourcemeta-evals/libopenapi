...
func (s *Schema) Build(ctx context.Context, root *yaml.Node, idx *index.SpecIndex) error {
	...
	_, dynamicAnchorLabel, dynamicAnchorNode := utils.FindKeyNodeFullTop(AnchorLabel, root.Content)
	...
	_, dynamicRefLabel, dynamicRefNode := utils.FindKeyNodeFullTop(DynamicAnchorLabel, root.Content)

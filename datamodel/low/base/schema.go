...
type Schema struct {
	...
	Comment               low.NodeReference[string]                                                              // JSON Schema 2020-12 $comment - schema author comments
	ContentSchema         low.NodeReference[*SchemaProxy]                                                        // JSON Schema 2020-12 contentSchema - schema for string content validation

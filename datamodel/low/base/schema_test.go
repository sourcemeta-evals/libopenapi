...
description: A schema with comment`
	...
	assert.Equal(t, "This is a developer comment", sch.Comment.Value)
...
contentSchema:
  ...
  properties:
	...
	// Verify the content schema properties
...
description: A schema without contentSchema`
	...
	assert.Nil(t, sch.ContentSchema.Value)
}
...
func TestSchema_Vocabulary(t *testing.T) {
  ...
  "https://json-schema.org/draft/2020-12/vocab/validation": false`
	...
	for key, val := range sch.Vocabulary.Value.FromOldest() {
		switch key.Value {

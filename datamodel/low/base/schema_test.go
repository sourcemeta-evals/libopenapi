...
$vocabulary:
  ...
  "https://json-schema.org/draft/2020-12/vocab/validation": false`
	...
	var keys []string
	for k := range sch.Vocabulary.Value.FromOldest() {
		keys = append(keys, k.Value)
	}
	assert.Contains(t, keys, "https://json-schema.org/draft/2020-12/vocab/core")
	assert.Contains(t, keys, "https://json-schema.org/draft/2020-12/vocab/applicator")
	assert.Contains(t, keys, "https://json-schema.org/draft/2020-12/vocab/validation")
}

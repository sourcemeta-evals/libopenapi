...
description: a schema with dynamic anchor and ref`
	...
	assert.Equal(t, "#myRef", sch.DynamicRef.Value)
...
$dynamicAnchor: onlyAnchor`
	...
	assert.Equal(t, "onlyAnchor", sch.DynamicAnchor.Value)
...
$dynamicRef: "#refOnly"`
	...
	assert.Equal(t, "#refOnly", sch.DynamicRef.Value)
...
$dynamicRef: "#ref2"`
	...
	// Different dynamic anchors and refs should produce different hashes

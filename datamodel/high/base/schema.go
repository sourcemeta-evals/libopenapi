...
type Schema struct {
	...
	// 3.1 only, provides a way to define a dynamic anchor for recursive schema references
	DynamicAnchor string `json:"$dynamicAnchor,omitempty" yaml:"$dynamicAnchor,omitempty"`

	// 3.1 only, provides a way to reference a dynamic anchor for recursive schema references

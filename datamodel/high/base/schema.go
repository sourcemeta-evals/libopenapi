...
type Schema struct {
	...
	// 3.1 only, part of the JSON Schema 2020-12 spec, used to create a dynamic anchor point
	DynamicAnchor string `json:"$dynamicAnchor,omitempty" yaml:"$dynamicAnchor,omitempty"`

	// 3.1 only, part of the JSON Schema 2020-12 spec, used to reference a dynamic anchor

...
type Schema struct {
	...
	// JSON Schema 2020-12 $comment - a comment for schema authors
	Comment string `json:"$comment,omitempty" yaml:"$comment,omitempty"`

	// JSON Schema 2020-12 contentSchema - schema for validating string-encoded content
	ContentSchema *SchemaProxy `json:"contentSchema,omitempty" yaml:"contentSchema,omitempty"`

	// JSON Schema 2020-12 $vocabulary - declares which vocabularies are used in the schema

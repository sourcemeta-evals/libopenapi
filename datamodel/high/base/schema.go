...
type Schema struct {
	...
	// 3.1 only (2020-12), $dynamicAnchor is used to define a dynamic anchor point for recursive schemas
	DynamicAnchor string `json:"$dynamicAnchor,omitempty" yaml:"$dynamicAnchor,omitempty"`

	// 3.1 only (2020-12), $dynamicRef is used to reference a dynamic anchor point

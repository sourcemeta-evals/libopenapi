...
type Schema struct {
	...
	// 3.1 only (JSON Schema 2020-12), $dynamicAnchor defines a dynamic anchor for recursive schema references
	DynamicAnchor string `json:"$dynamicAnchor,omitempty" yaml:"$dynamicAnchor,omitempty"`

	// 3.1 only (JSON Schema 2020-12), $dynamicRef is a dynamic reference that resolves based on dynamic scope

...
type Schema struct {
	...
	// 3.1+ only, JSON Schema 2020-12 $comment - provides a way to leave comments in schemas
	Comment string `json:"$comment,omitempty" yaml:"$comment,omitempty"`

	// 3.1+ only, JSON Schema 2020-12 contentSchema - defines the schema for content encoded by contentMediaType
	ContentSchema *SchemaProxy `json:"contentSchema,omitempty" yaml:"contentSchema,omitempty"`

	// 3.1+ only, JSON Schema 2020-12 $vocabulary - declares which vocabularies are used and whether they are required

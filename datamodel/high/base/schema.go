...
type Schema struct {
	...
	// 3.1+ only, JSON Schema 2020-12 $comment - purely informational annotation
	Comment string `json:"$comment,omitempty" yaml:"$comment,omitempty"`

	// 3.1+ only, JSON Schema 2020-12 contentSchema - describes the structure of string content
	ContentSchema *SchemaProxy `json:"contentSchema,omitempty" yaml:"contentSchema,omitempty"`

	// 3.1+ only, JSON Schema 2020-12 $vocabulary - declares required/optional vocabularies in meta-schemas

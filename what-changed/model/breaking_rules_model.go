...
type PathItemRules struct {
	...
	Query                *BreakingChangeRule `json:"querymethod,omitempty" yaml:"querymethod,omitempty"`
	AdditionalOperations *BreakingChangeRule `json:"additionalops,omitempty" yaml:"additionalops,omitempty"`
...
type MediaTypeRules struct {
	Example      *BreakingChangeRule `json:"example,omitempty" yaml:"example,omitempty"`
	Schema       *BreakingChangeRule `json:"schema,omitempty" yaml:"schema,omitempty"`
	ItemSchema   *BreakingChangeRule `json:"item_schema,omitempty" yaml:"item_schema,omitempty"`
	ItemEncoding *BreakingChangeRule `json:"item_encoding,omitempty" yaml:"item_encoding,omitempty"`
}
...
type SecuritySchemeRules struct {
	...
	OAuth2MetadataUrl *BreakingChangeRule `json:"oauth2_metadata_url,omitempty" yaml:"oauth2_metadata_url,omitempty"`

...
func buildDefaultRules() *BreakingRulesConfig {
	return &BreakingRulesConfig{
		...
		PathItem: &PathItemRules{
			...
			Query:                rule(false, false, true), // OpenAPI 3.2+
			AdditionalOperations: rule(false, false, true), // OpenAPI 3.2+
		...
		MediaType: &MediaTypeRules{
			Example:      rule(false, false, false),
			Schema:       rule(true, false, true),
			ItemSchema:   rule(true, false, true), // OpenAPI 3.2+
			ItemEncoding: rule(true, false, true), // OpenAPI 3.2+
		},
		...
		SecurityScheme: &SecuritySchemeRules{
			...
			OAuth2MetadataUrl: rule(false, false, false), // OpenAPI 3.2+

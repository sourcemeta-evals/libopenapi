...
// TestOpenAPI32_PathItem_Query tests the query (Path Item) breaking rules.
...
// TestOpenAPI32_PathItem_AdditionalOperations tests the additionalOperations (Path Item) breaking rules.
...
// TestOpenAPI32_MediaType_ItemSchema tests the itemSchema (Media Type) breaking rules.
...
// TestOpenAPI32_MediaType_ItemEncoding tests the itemEncoding (Media Type) breaking rules.
...
// TestOpenAPI32_SecurityScheme_OAuth2MetadataUrl tests the oauth2MetadataUrl (Security Scheme) breaking rules.
func TestOpenAPI32_SecurityScheme_OAuth2MetadataUrl(t *testing.T) {
	...
	// oauth2MetadataUrl: changes are not breaking
...
func TestOpenAPI32_MergeOverride_NewProperties(t *testing.T) {
	...
	assert.True(t, *config.MediaType.Schema.Removed)
}

// TestOpenAPI32_IsBreaking_NewProperties_ChangeTypes tests IsBreaking across all change types
// for the new OpenAPI 3.2 properties.
func TestOpenAPI32_IsBreaking_NewProperties_ChangeTypes(t *testing.T) {
	ResetDefaultBreakingRules()
	defer ResetDefaultBreakingRules()
